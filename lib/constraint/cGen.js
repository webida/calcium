    ...
    var constraintGenerator = walk.make({
        ...
        AssignmentExpression: function (node, curStatus, c) {
            ...
            if (node.operator === '=') {
                ...
                if (propAcc[0] === 'numberLiteral') {
                    objAVal.propagate(new cstr.WriteProp(undefined, rhsAVal));
                }
                return rhsAVal;
            }
        ...
        ArrayExpression: function (node, curStatus, c) {
            ...
            for (var i = 0; i < node.elements.length; i++) {
                ...
                constraints.push({OBJ: ret, PROP: undefined, AVAL: eltAVal});
                ret.propagate(new cstr.WriteProp(i, eltAVal));
                ret.propagate(new cstr.WriteProp(undefined, eltAVal));
            }
            return ret;
        },

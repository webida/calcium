...
*/
    ...
    var rtCX = {
        ...
        protos: {
            Object: ObjProto,
            Function: new types.ObjType(ObjProto, 'Function.prototype'),
            Array: new types.ObjType(ObjProto, 'Array.prototype'),
            RegExp: new types.ObjType(ObjProto, 'RegExp.prototype'),
            String: new types.ObjType(ObjProto, 'String.prototype'),
            Number: new types.ObjType(ObjProto, 'Number.prototype'),
            Boolean: new types.ObjType(ObjProto, 'Boolean.prototype')
        }

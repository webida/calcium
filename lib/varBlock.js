...
const declaredVariableFinder = walk.make({
    Function: (node, currBlock, c) => {
        ...
        c(node.body, funcBlock, walk.base.BlockStatement);
    },
    ...
    CatchClause: (node, currBlock, c) => {
        ...
        c(node.body, catchBlock, walk.base.BlockStatement);
    },
    ...
    BlockStatement: (node, currBlock, c) => {
        ...
        c(node, inBlock, walk.base.BlockStatement);
    }
});
...
const variableUsageCollector = walk.make({
    ...
    BlockStatement: (node, currBlock, c) => {
        ...
        c(node, node['@block'] || currBlock, walk.base.BlockStatement);
    }
});
...
export function annotateBlockInfo(ast, gVarBlock) {
    ...
    myWalker.recursiveOverrideFunctions(ast, gVarBlock, declaredVariableFinder);
    myWalker.recursiveOverrideFunctions(ast, gVarBlock, variableUsageCollector);
    return ast;
}

...
FnType.prototype.getArgumentsObject = function (delta) {
    this.argObjMap = this.argObjMap || Object.create(null);
    var argObj = this.argObjMap[delta]
        || (this.argObjMap[delta]
            = new ObjType(new AVal(this.argProto), '*arguments object*'));
    return argObj;
};
